...
import { Flex, Stack, Image, Text, Menu, MenuButton, MenuList, MenuItem, Button } from "@chakra-ui/react";
          ...
          >
            <Stack>
              ...
              <Text
                ...
                paddingRight="20px"
                paddingTop="10px"
                onClick={() => {setActive1(true); setActive2(false); setActive3(false); setActiveProfile(false)}}
              >
                <NavLink href="/">
                  Home
                </NavLink>
              ...
              <Stack>
                ...
                <Menu>
                  <MenuButton  
                    ...
                    paddingRight="20px"
                    paddingTop="10px"
                    onClick={() => {setActive2(!active2); setActive1(false); setActive3(false); setActiveProfile(false)}}
            ...
            <Stack>
              ...
              <Text
                ...
                paddingLeft="20px"
                paddingTop="10px"
                onClick={() => {setActive3(true); setActive2(false); setActive1(false); setActiveProfile(false)}}
              >
                <NavLink href="/ssr">
                  Realtime
                </NavLink>
