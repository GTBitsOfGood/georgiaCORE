    ...
    <Table variant="unstyled" size="lg">
      ...
      <Tbody overflowY="auto">
        {authUsers && authUsers.map((authUser) => (
          ...
          >
            <Td wordBreak="break-word" paddingInlineStart={5} paddingInlineEnd={200} fontFamily="sans-serif" fontWeight={600}>
              {authUser.email}
            </Td>
            ...
            <Td>
                ...
                <AuthUsersDeleteAlert calculate={calculate} email={authUser.email}></AuthUsersDeleteAlert>
