...
const AuthUsersDeleteAlert = ({ calculate, email }) => {
  ...
  return (
    <>
      <Button w={5} h={5} bgColor="white" onClick={onOpen}>
        ...
        <ModalContent alignSelf="center">
          ...
          <ModalBody border="1px solid #E2E8F0" wordBreak="break-word">
            <Stack direction="row" wrap="wrap" spacing={0}>
              <Text letterSpacing="tight" fontWeight="semibold">
                Are you sure you want to delete
              </Text>
              <Text color="white">.</Text>
              <Text letterSpacing="tight" fontWeight="bold">
                {email}
              </Text>
              <Text color="white">.</Text>
              <Text letterSpacing="tight" fontWeight="semibold">
...
AuthUsersDeleteAlert.propTypes = {
